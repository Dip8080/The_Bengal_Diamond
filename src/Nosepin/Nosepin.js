...
return (
    ...
    <div>
        <div>
        <h1 className="text-center text-2xl shadow text-orange-300 p-2">Diamond Nosepin</h1>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3">        {
            nosepin.slice(10,20).map(x=> <NosepinDetails diamondWeight={x.Diamond_weight}
...
const NosepinDetails = ({diamondWeight,diamondPieces,img,grossWeight,model,img2}) =>{
    ...
    <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      ...
      <span href="" class="">❯</span>
              ...
              <div class="py-6 px-8 rounded-lg bg-white">
                ...
                <p class="text-gray-700 tracking-wide">Diamond pieces : {diamondPieces}</p>
